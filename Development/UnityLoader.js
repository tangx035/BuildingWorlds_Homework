...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'Homework1_cave.data';
    var REMOTE_PACKAGE_BASE = 'Homework1_cave.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3802938;
      var PACKAGE_UUID = 'dbbd39a2-2ce8-40d1-9417-d4616b3ad805';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 947074, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(947074, 947093, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(947093, 952589, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(952589, 2900341, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2900341, 3775313, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3775313, 3802938, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_Homework1_cave.data');

    };
    Module['addRunDependency']('datafile_Homework1_cave.data');
